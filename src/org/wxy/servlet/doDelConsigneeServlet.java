...
public class doDelConsigneeServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public doDelConsigneeServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int iRow=dao.delConsignees(Integer.parseInt(consigneeId));
		if(iRow>0){
			response.sendRedirect("doGetConsigneeServlet");
		}else{
		}
	}
