...
public class doGetConsigneeServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public doGetConsigneeServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Consignee> consigneeList=consigneedao.getConsigneeByUserId(userId);
		request.setAttribute("consigneeList", consigneeList);
		request.getSession().setAttribute("id",0);
		request.getRequestDispatcher("editConsignee.jsp").forward(request, response);
	}
