...
public class doUpdatePassServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public doUpdatePassServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String userPass=request.getParameter("newPassOne");
		/*重新封装user*/
		...
		updatesession.setAttribute("user",newUser);
		updatesession.setAttribute("uname",userName);
		updatesession.setAttribute("upass",userPass);
