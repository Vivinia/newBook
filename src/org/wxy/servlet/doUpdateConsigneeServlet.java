...
public class doUpdateConsigneeServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public doUpdateConsigneeServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("updateConsignee.jsp").forward(request, response);
